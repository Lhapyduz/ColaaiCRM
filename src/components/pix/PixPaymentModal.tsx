...
export default function PixPaymentModal({
    ...
    return (
        ...
        >
            <div
                className="relative bg-bg-card rounded-2xl max-w-[400px] w-full max-h-[90vh] overflow-y-auto shadow-[0_20px_40px_rgba(0,0,0,0.2)] animate-fadeInUp max-[480px]:max-h-[95vh] max-[480px]:rounded-xl"
