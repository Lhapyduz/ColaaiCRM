        ...
        <div className="min-h-screen bg-background">
            <div className="max-w-[800px] mx-auto px-6 py-12">
                ...
                <div className="prose prose-invert max-w-none">
                    ...
                    <section className="mb-8"><h2 className="text-xl font-semibold mb-3 text-primary">5. Período de Teste Gratuito</h2><p className="text-text-secondary leading-relaxed">Oferecemos 7 dias de teste gratuito para novos usuários. Durante este período, você terá acesso às funcionalidades do plano Avançado. Não é necessário informar dados de pagamento para iniciar o período de teste.</p></section>
