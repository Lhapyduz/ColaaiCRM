...
import { logIngredientCreated, logIngredientUpdated, logIngredientDeleted, logStockMovement } from '@/infra/logging/actionLogger';
...
export default function EstoquePage() {
    ...
    if (!canAccess('inventory')) {
        return <UpgradePrompt feature="Controle de Estoque" requiredPlan="Avançado" currentPlan={plan} fullPage />;
    }
