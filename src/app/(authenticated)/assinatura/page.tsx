...
import AbacatepayPixModal from '@/components/pix/AbacatepayPixModal';
...
const AssinaturaPage = () => {
    ...
    const handlePixPaymentConfirmed = async () => { await refreshSubscription(); setPixModalPlan(null); };
    ...
    return (
        <div className="max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col items-center mb-8">
                ...
                {paymentMethod === 'pix' && <p className="text-xs text-text-muted mt-2">Pagamento via PIX com QR Code dinâmico. Acesso liberado automaticamente após confirmação.</p>}
            </div>
            ...
            {pixModalPlan && <AbacatepayPixModal planType={pixModalPlan.type} planName={pixModalPlan.name} amount={PLAN_PRICES[pixModalPlan.type]} onClose={() => setPixModalPlan(null)} onPaymentConfirmed={handlePixPaymentConfirmed} />}
        </div>
    );
}
